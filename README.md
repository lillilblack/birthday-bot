...
✅ **网页版已经做好了**（纯只读静态页，全队都能查）：**https://lillilblack.github.io/birthday-bot/**

部署与同步说明见 [docs/网页部署教程.md](docs/网页部署教程.md)。
...
每届队长换届时，照着 [docs/移交教程.md](docs/移交教程.md) 走一遍即可。注意：微信绑定是「一人一 bot」，微信凭证必须新队长自己重新扫码，代码/名单/网页/教程走 GitHub 交接。
